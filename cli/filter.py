...
def parallel_write(src_lang, src_entry, tgt_lang, tgt_entry):
    src_out = open('./pib/pib_en-{}.{}.filt.lang.txt'.format(src_lang, src_lang),'a')
    tgt_out = open('./pib/pib_en-{}.{}.filt.lang.txt'.format(src_lang, tgt_lang),'a')
...
if __name__ == '__main__':
    ...
    langid.set_languages(['{}'.format(src_lang),'{}'.format(tgt_lang)])
